...
Windows may work through Docker, but the contributor-ready share only treats macOS and Linux as first-class tested platforms.

## Maintainability Before Ship

Keep `src/workbench/app.py` as a thin entrypoint.
